    ...
    stages {
        stage('Hello') {
            ...
            steps {
                echo 'Testing'
                script {
                    def url = 'https://test-env-jenkins-honda.s3.ap-northeast-1.amazonaws.com/index.html'
            ...
            steps {
                ...
                withCredentials([[
                    ...
                    accessKeyVariable: 'AWS_ACCESS_KEY_ID',
                    secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]){
                        sh(script: 'aws s3 cp https://test-env-jenkins-honda.s3.ap-northeast-1.amazonaws.com/index.html s3://prod-env-jenkins-honda/')
                }
            }
        }
    }
